...
class TopicoServiceTest {
    /* Todos abaixo são apenas os mocks para efetuar os testes */
    ...
    @Test
    fun `deve listar todos os topicos quando o curso for nulo`() {
    ...
    @Test
    fun `deve lista notFoundException quando topico nao for achado`() {
